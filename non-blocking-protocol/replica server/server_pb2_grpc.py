...
class ServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PrimaryDelete = channel.unary_unary(
                '/a21.Server/PrimaryDelete',
                request_serializer=server__pb2.Message.SerializeToString,
                response_deserializer=server__pb2.Message.FromString,
                )
        self.ServerDelete = channel.unary_unary(
                '/a21.Server/ServerDelete',
                request_serializer=server__pb2.Message.SerializeToString,
                response_deserializer=server__pb2.Message.FromString,
                )
...
class Server(object):
    ...
    def PrimaryDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/a21.Server/PrimaryDelete',
            server__pb2.Message.SerializeToString,
            server__pb2.Message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ServerDelete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/a21.Server/ServerDelete',
            server__pb2.Message.SerializeToString,
            server__pb2.Message.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
